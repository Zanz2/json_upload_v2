...
class JsonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create json" do
    assert_difference('Json.count') do
      post jsons_url, params: { json: { content_type: @json.content_type, file_contents: @json.file_contents, filename: @json.filename } }
    end
  ...
  test "should update json" do
    patch json_url(@json), params: { json: { content_type: @json.content_type, file_contents: @json.file_contents, filename: @json.filename } }
